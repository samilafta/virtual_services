                        ...
                        <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Price</label>
                                        <input type="text" class="form-control border-input" name="price" pattern="\d{0,10}\.?\d{0,2}" title="eg. 55.00" required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Stock</label>
                                        <input type="number" class="form-control border-input" name="stock" min="1" value="1" required>
                                    </div>
                                </div>
